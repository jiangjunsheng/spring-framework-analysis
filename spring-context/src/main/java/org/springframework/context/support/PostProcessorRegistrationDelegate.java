...
class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		* 可能会有些情况，当spring的配置中的后处理器还没有
		* 被注册就已经开始了bean的初始化时，便会打印出BeanPostProcessorChecker中设定的信息*/
		...
		/* 第四步，注册所有MergeedBeanDefinitionPostProcessor
		 * 类型的BeanPostProcessor，并非重复注册，
